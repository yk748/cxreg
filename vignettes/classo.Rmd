...
Like other R packages on Github, it can be downloaded by the command: \textcolor{red}{YK2SSR: The following chunk is not working since the repo in Github is still in private. This will be open accessible by next week. Please ask me if you need an access the repo.}
