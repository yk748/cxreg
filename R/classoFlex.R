...
#' cglasso objective function value
#'
#' Returns the cglasso objective function value.
#'
#' @param y Quantitative response variable.
...
#' cglasso penalty value
#'
#' Returns the cglasso penalty value.
#'
